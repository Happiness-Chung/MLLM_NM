    ...
    def initialize_vision_modules(self, model_args, fsdp=None):
        ...
        if getattr(self, "mm_projector", None) is None:
            ...
            for p in self.mm_projector.parameters():
                p.data = p.data.float() #### for llava 1.6
                p.requires_grad = True
...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, images):###############################################################################
        ...
        # image_features.data = image_features.data.float()
    ...
    def prepare_inputs_labels_for_multimodal(self, input_ids, position_ids, attention_mask, past_key_values, labels, images, modalities=["image"], image_sizes=None):
        ...
        # print(images, input_ids.shape[1])
        # The image in this code seems processed.
        ...
        if type(images) is list or images.ndim == 5:
            ...
            image_features = self.encode_images(images.half())
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            # print(len(cur_input_ids_noim), len(cur_labels_noim))
            ...
            # print(cur_new_input_embeds.size(), cur_new_labels.size())
